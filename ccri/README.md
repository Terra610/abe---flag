...
**CCRI (Constitutional Capital Recovery Index)** is an A.B.E. engine module that measures how consumer credit, auto lending, and banking practices diverge from the constitutional and federal legal framework.
